...
public class SlidingLayer extends FrameLayout {
    ...
    private ISlidingLayerOpenCloseListener mOpenCloseListener;
    public void setOpenCloseListener(ISlidingLayerOpenCloseListener mOpenCloseListener) {
		this.mOpenCloseListener = mOpenCloseListener;
	}
    
    public interface ISlidingLayerOpenCloseListener{
    	void onSlidingLayerOpened();
    	void onSlidingLayerClosed();
    }
